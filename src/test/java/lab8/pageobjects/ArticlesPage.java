...
public class ArticlesPage {
    ...
    public List<String> getAllArticleMenuItems(WebDriver driver){
        return TestHelper.getAllMenuItems(driver, loc_menu_items);
    }

    public SelectedArticlePage clickOnReadMoreButton(WebDriverWait waiter, int post_num) throws Exception {
